...
// A SrotmParams contains Givens transformation parameters returned
...
// A DrotmParams contains Givens transformation parameters returned
...
// A Transpose is used to specify the transposition operation for a
// routine.
type Transpose int
...
// A Uplo is used to specify whether the matrix is an upper or lower
// triangular matrix.
type Uplo int
...
// A Diag is used to specify whether the matrix is a unit or non-unit
// triangular matrix.
type Diag int
...
// A Side is used to specify from which side a multiplication operation
// is performed.
type Side int
