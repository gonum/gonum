...
func TestD1x(t *testing.T) {
	for _, test := range d1xTests {
...
`,
	},
	{
		...
		err:  fmt.Errorf("could not create first derivative generator: invalid function signature for ErrF1"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF2"},
		err:  fmt.Errorf("could not create first derivative generator: invalid function signature for ErrF2"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF3"},
		err:  fmt.Errorf("could not create first derivative generator: invalid function signature for ErrF3"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF4"},
		err:  fmt.Errorf("could not create first derivative generator: invalid function signature for ErrF4"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF5"},
		err:  fmt.Errorf("could not generate first derivative: naked returns not supported"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF6"},
		err:  fmt.Errorf("could not generate first derivative: can not handle functions with multiple return statements"),
	},
	{
	...
	},
	{
		...
		err:  fmt.Errorf(`could not create first derivative generator: could not find package "gonum.org/v1/gonum/diff/autofd/internal/testfuncXXX"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "F1xxx"},
		err:  fmt.Errorf(`could not create first derivative generator: could not find F1xxx in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "Fxxx.F"},
		err:  fmt.Errorf(`could not create first derivative generator: could not find Fxxx in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "F1.F"},
		err:  fmt.Errorf(`could not create first derivative generator: object F1 in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc" is not a named type (*types.Func)`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "T1"},
		err:  fmt.Errorf(`could not create first derivative generator: object T1 in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc" is not a func (*types.TypeName)`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "T1.Fxxx"},
		err:  fmt.Errorf(`could not create first derivative generator: could not find T1.Fxxx in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrT1.F"},
		err:  fmt.Errorf(`could not create first derivative generator: could not find ErrT1.F in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
}
...
`,
	...
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF1"},
		err:  fmt.Errorf("could not create second derivative generator: invalid function signature for ErrF1"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF2"},
		err:  fmt.Errorf("could not create second derivative generator: invalid function signature for ErrF2"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF3"},
		err:  fmt.Errorf("could not create second derivative generator: invalid function signature for ErrF3"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF4"},
		err:  fmt.Errorf("could not create second derivative generator: invalid function signature for ErrF4"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF5"},
		err:  fmt.Errorf("could not generate second derivative: naked returns not supported"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF6"},
		err:  fmt.Errorf("could not generate second derivative: can not handle functions with multiple return statements"),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrF7"},
		err:  fmt.Errorf("could not generate second derivative: can not handle functions with multiple return statements"),
	...
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfuncXXX", Name: "F1"},
		err:  fmt.Errorf(`could not create second derivative generator: could not find package "gonum.org/v1/gonum/diff/autofd/internal/testfuncXXX"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "F1xxx"},
		err:  fmt.Errorf(`could not create second derivative generator: could not find F1xxx in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "Fxxx.F"},
		err:  fmt.Errorf(`could not create second derivative generator: could not find Fxxx in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "F1.F"},
		err:  fmt.Errorf(`could not create second derivative generator: object F1 in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc" is not a named type (*types.Func)`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "T1"},
		err:  fmt.Errorf(`could not create second derivative generator: object T1 in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc" is not a func (*types.TypeName)`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "T1.Fxxx"},
		err:  fmt.Errorf(`could not create second derivative generator: could not find T1.Fxxx in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
	{
		name: autofd.Func{Path: "gonum.org/v1/gonum/diff/autofd/internal/testfunc", Name: "ErrT1.F"},
		err:  fmt.Errorf(`could not create second derivative generator: could not find ErrT1.F in package "gonum.org/v1/gonum/diff/autofd/internal/testfunc"`),
	},
}
