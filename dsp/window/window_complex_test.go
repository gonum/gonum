...
func TestWindowComplex(t *testing.T) {
	...
	var tt []*testingCaseCmplx = []*testingCaseCmplx{
		...
		&testingCaseCmplx{Name: "SineComplex", Function: SineComplex,
		...
		&testingCaseCmplx{Name: "FlatTopComplex", Function: FlatTopComplex,
			ExpectedResult: []float64{-0.000421, -0.003687, -0.017675, -0.045939, -0.070137, -0.037444, 0.115529, 0.402051, 0.737755, 0.967756,
