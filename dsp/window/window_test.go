...
var gausWindowTests = []struct {
	...
	{
		name: "Gauss (sigma=0.3)", sigma: 0.3,
	...
	{
		name: "Gauss (sigma=0.5)", sigma: 0.5,
	...
	{
		name: "Gauss (sigma=1.2)", sigma: 1.2,
