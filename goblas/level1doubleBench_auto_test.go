...
b.ResetTimer()
for i := 0; i < b.N; i++{
	blasser.Daxpy(n, alpha, x, incX, y, incY)
}
}
...
b.ResetTimer()
for i := 0; i < b.N; i++{
	blasser.Drot(n, x, incX, y, incY, c, s)
}
}
...
b.ResetTimer()
for i := 0; i < b.N; i++{
	blasser.Drotm(n, x, incX, y, incY, p)
}
}
