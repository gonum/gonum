...
// lean returns a core of the RDF graph f using the given strategy.
//
...
// join evaluate the given pattern, q, joining with solutions in mu.
// This is takes only a single mapping and so only works for the DFS strategy.
//
