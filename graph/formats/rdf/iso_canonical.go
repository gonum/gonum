...
// sortLexical implements lexical sorting of [][]byte.
func sortLexical(s [][]byte) {
	sorted.BySliceValues(s)
}
...
// byLengthHash implements ascending length sort for a set of blank RDF
