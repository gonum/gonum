...
//
// If compq is UpdateSchur, on return the matrix Q of Schur vectors will be
// updated by postmultiplying it with Z.
// If compq is None, the matrix Q is not referenced and will not be
// updated.
...
func (impl Implementation) Dtrexc(compq EVComp, n int, t []float64, ldt int, q []float64, ldq int, ifst, ilst int, work []float64) (ifstOut, ilstOut int, ok bool) {
