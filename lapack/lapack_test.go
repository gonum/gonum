...
var impl = lapack.Implementation{}
...
func TestDlahr2(t *testing.T) {
	testlapack.Dlahr2Test(t, impl, "testlapack/testdata/dlahr2data.json.gz")
}
...
func TestDlaqr5(t *testing.T) {
	testlapack.Dlaqr5Test(t, impl, "testlapack/testdata/dlaqr5data.json.gz")
}
