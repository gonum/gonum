...
// P is a matrix of the eigenvectors of A. Factorize computes the eigenvalue
// decomposition with the eigenvalues ordered ascending. If the vectors input
// argument is false, the eigenvectors are not computed.
//
