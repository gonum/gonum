...
func TestEigen(t *testing.T) {
	for i, test := range []struct {
		...
		},
		{
			...
			values: []complex128{1, 0.7300317046114154, complex(-0.1400158523057075, 0.452854925738716), complex(-0.1400158523057075, -0.452854925738716)},
			left: NewCDense(4, 4, []complex128{
				0.5, -0.3135167160788314, complex(0.0205812178013689, -0.0045809393001271), complex(0.0205812178013689, 0.0045809393001271),
				0.5, 0.7842199280224774, complex(-0.3755102695419336, 0.2924634904103882), complex(-0.3755102695419336, -0.2924634904103882),
				0.5, 0.3320220078078358, complex(-0.1605261632278496, -0.3881393645202528), complex(-0.1605261632278496, 0.3881393645202528),
				0.5, 0.4200806584012395, 0.7723935249234153, 0.7723935249234153,
			}),
			right: NewCDense(4, 4, []complex128{
				0.9476399565969628, -0.8637347682162745, complex(-0.2688989440320280, -0.1282234938321029), complex(-0.2688989440320280, 0.1282234938321029),
				0.2394935907064427, 0.3457075153704627, complex(-0.3621360383713332, -0.2583198964498771), complex(-0.3621360383713332, 0.2583198964498771),
				0.1692743801716332, 0.2706851011641580, 0.7426369401030960, 0.7426369401030960,
				0.1263626404003607, 0.2473421516816520, complex(-0.1116019576997347, 0.3865433902819795), complex(-0.1116019576997347, -0.3865433902819795),
			}),
		},
	} {
...
func cmplxEqualTol(v1, v2 []complex128, tol float64) bool {
	for i, v := range v1 {
		if !floats.EqualWithinAbsOrRel(real(v), real(v2[i]), tol, tol) {
			return false
		}
		if !floats.EqualWithinAbsOrRel(imag(v), imag(v2[i]), tol, tol) {
			return false
		}
	}
	return true
