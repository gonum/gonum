...
var autogen []byte = []byte(`// This file is autogenerated by autogen/autogen_bench_level1double.go`)
...
func main() {
	...
	pkgs := []struct{ name string }{{name: "referenceblas"}}
...
func writeLevel1Benchmark(fun level1functionStruct, f *os.File) {
	...
	f.WriteString("\tblasser." + fun.camel + "(")
